...
static const char qt_meta_stringdata_ColorButton[] = {
    "ColorButton\0\0valueChanged()\0"
    "valueChanged(QColor)\0clickedSLOT()\0"
};
...
void ColorButton::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->valueChanged((*reinterpret_cast< const QColor(*)>(_a[1]))); break;
...
// SIGNAL 1
void ColorButton::valueChanged(const QColor & _t1)
{
